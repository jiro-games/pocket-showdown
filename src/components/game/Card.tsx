...
import { Card as CardType, PokemonCard, TrainerCard, Language } from '@/types/game';
import { getLocalizedText } from '@/data/cardLoader';
...
export function Card({ card, language = 'en', className, onClick, isSelected, showDetails = true }: CardProps) {
      ...
      <div className="p-2 h-20 flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between">
          <span className={cn(
            ...
            card.type === 'pokemon' ? getTypeColor((card as PokemonCard).pokemonType) :
            'bg-purple-500'
          )}>
            {card.type === 'pokemon' ? (card as PokemonCard).pokemonType :
             'trainer'}
          </span>
