...
import { cardLoader, getLocalizedText, type Language } from '@/lib/cardLoader';
  ...
  const filteredAndSortedCards = useMemo(() => {
    ...
    if (filterRarity !== 'all') {
      filtered = filtered.filter(
        (card: CardType) => card.rarity === filterRarity
      );
    }
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    value={filterRarity}
                    onChange={e =>
                      setFilterRarity(e.target.value as FilterRarity)
                    }
                    className="w-full px-3 py-2 bg-white/5 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                  >
                    <option value="all" className="bg-gray-800 text-white">
                    ...
                    <option value="common" className="bg-gray-800 text-white">
                      Common
                    </option>
                    <option value="uncommon" className="bg-gray-800 text-white">
                      Uncommon
                    </option>
                    <option value="rare" className="bg-gray-800 text-white">
                      Rare
                    </option>
                    <option
                      value="ultra-rare"
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="set" className="bg-gray-800 text-white">
                      Set
                    </option>
                  </select>
                </div>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-1/2 space-y-4">
                ...
                {selectedCard.type === 'pokemon' &&
                  'attacks' in selectedCard && (
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">
                        Attacks
                      </h3>
                      <div className="space-y-2">
                        {(selectedCard as PokemonCard).attacks.map(
                          (attack, index) => (
